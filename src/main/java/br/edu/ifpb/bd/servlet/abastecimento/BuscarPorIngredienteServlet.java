...
@WebServlet("/BuscarPorIngrediente")
public class BuscarPorIngredienteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<AbastecimentoLoja> lista =
                dao.listarAbastecimentoIngrediente(nomeIngrediente);

        request.setAttribute("lista", lista);
        request.getRequestDispatcher("/abastecimento/BuscarAbastecimentoPorIngrediente.jsp")
